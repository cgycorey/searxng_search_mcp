"""
Simple demonstration of complete search + analysis workflow.

This shows how to analysis tool integrates with the MCP server
and how the LLM would naturally chain tools together.
"""
...
def demonstrate_complete_workflow():
    """Demonstrate complete workflow from search to analysis."""
    ...
    print(f"• Total sources analyzed: {domain_dist['total_domains']}")
    print(f"• Unique domains: {domain_dist['unique_domains']}")
    print(
    ...
    print()
    print("**Key Insights:**")
    print("• Most credible information comes from official government sources")
    ...
    examples = [
        {
            ...
            "llm_reasoning": [
                "1. ✅ User explicitly requests 'analyze the sources'",
                "2. ✅ Call metasearch_web('Python programming tutorials') first",
                "3. ✅ Extract results from search response",
                "4. ✅ Call analyze_search_results(results, 'sources')",
                "5. ✅ Provide combined search + source analysis response",
            ],
        },
        {
            ...
            "llm_reasoning": [
                ...
                "2. ✅ Call metasearch_web('artificial intelligence trends') first",
                "3. ✅ Extract results from search response",
        ...
        },
        {
            ...
            "llm_reasoning": [
                ...
                "2. ✅ Call metasearch_web('climate change') first",
                "3. ✅ Extract results from search response",
        ...
        },
        {
            ...
            "llm_reasoning": [
                "1. ❌ User only requests search, no analysis mentioned",
                "2. ✅ Call only metasearch_web('machine learning resources')",
                "3. ❌ Do NOT call analysis tool unless user follows up",
            ],
        },
    ]
...
def show_analysis_types_examples():
    ...
    analysis_types = {
        ...
        "sources": [
            "User Query: 'Find information about AI and check if the sources are credible'",
        ...
        "keywords": [
            "User Query: 'Search for machine learning and extract the key terms'",
        ...
        "relevance": [
            "User Query: 'Search for web development frameworks and rank them by quality'",
